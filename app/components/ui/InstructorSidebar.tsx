...
const InstructorSidebar = (props: Props) => {
  return (
    <div className="fixed mt-2 left-0 h-[89vh] w-[200px] flex flex-col items-center gap-6 pt-20 rounded-lg bg-gradient-to-b from-[#051429] to-black duration-300 text-gray-50  border-r-2 z-40 bg-opacity-75">
